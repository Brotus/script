...
& \impl \p{B} = \p{(B \backslash A) \cup A} = \p{B \backslash A} + \p{A}, \text{ da } P \text{ ein \WM \, ist} \\
...
\begin{align*}
&\p{\text{\glqq Student S mcht unendlich viele Fehler \grqq}} \\
